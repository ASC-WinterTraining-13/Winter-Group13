...
//		else 
		...
		if(bluetooth_ch04_get_rx_flag() == 1)
		{
			...
			if(bluetooth_rx_length > 0)
			{
				...
				OLED_ClearArea(24, 32, 104, 16);
				OLED_ClearArea(0, 48, 128, 16);
				if (bluetooth_rx_length > 13)
				{
					char line1[14] = {0};
					char line2[17] = {0};
					strncpy(line1, (const char*)bluetooth_rx_buffer, 13);
					line1[13] = '\0';
					strncpy(line2, (const char*)&bluetooth_rx_buffer[13], 16);
					line2[16] = '\0';
					OLED_Printf(24, 32, OLED_8X16, "%s", line1);
					OLED_Printf(0 , 48, OLED_8X16, "%s", line2);
